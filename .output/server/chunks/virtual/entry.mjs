	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			if (unref(isLibraryOpen) && !unref(isPlayerOpen)) {
				...
				_push(`<!--]--></div><div class="episode-detail"><span class="detail-pulse"></span><p>SELECTED EPISODE</p><strong>EP. ${ssrInterpolate(unref(displayedEpisode).number)} — ${ssrInterpolate(unref(displayedEpisode).title)}</strong></div></section>`);
			} else _push(`<!---->`);
